...
#define USE_BLEND_MODE 1

#define DISABLE_AUTO_FORMAT_POST    1

#define DEFINE_MASTER_IOS "i6"

#define ADMOB_ID1_DEFAULT "6305464951596521"
#define ADMOB_ID2_DEFAULT "1411367495"
#define CHARTBOOST_ID1_DEFAULT ""
#define CHARTBOOST_ID2_DEFAULT ""

#define UNITY_ADS_ID_DEFAULT "129387"
#define ADD_UNITYADS            1

#define ADD_VUNGLEADS           1
#define VUNGLE_ID_DEFAULT       "57ea22f998ccac9f49000044"

#define ADD_ADMOB_BANNER_ADS 1
#define ADD_ADMOB_BANNER_ID "ca-app-pub-6305464951596521/8934634290"

#define BANNER_XY CGPointMake(0,(IOS8_MASTER_H-100))
#define BANNER_WH CGSizeMake(IOS8_MASTER_W,100)// for portrail

#define IPAD_BANNER_XY CGPointMake(0,(1024-100))
#define IPAD_BANNER_WH CGSizeMake(768,100)// for portrail
